...
fun <FROM : Vertex, TO> BoundPathToMany<FROM, TO>.add(from: Collection<FROM>) = BoundPathToMany(froms.plus(from), path)
...
fun <FROM : Vertex, TO> BoundPathToOptional<FROM, TO>.add(from: Collection<FROM>) = BoundPathToOptional(froms.plus(from), path)
...
fun <FROM : Vertex, TO> BoundPathToSingle<FROM, TO>.add(from: Collection<FROM>) = BoundPathToSingle(froms.plus(from), path)
...
fun <FROM : Vertex, TO : Vertex> BoundRelationshipToMany<FROM, TO>.add(from: Collection<FROM>) = BoundRelationshipToMany(froms.plus(from), path)
...
fun <FROM : Vertex, TO : Vertex> BoundRelationshipToOptional<FROM, TO>.add(from: Collection<FROM>) = BoundRelationshipToOptional(froms.plus(from), path)
...
fun <FROM : Vertex, TO : Vertex> BoundRelationshipToSingle<FROM, TO>.add(from: Collection<FROM>) = BoundRelationshipToSingle(froms.plus(from), path)
...
fun <FROM : Vertex, TO> SingleBoundPathToMany<FROM, TO>.add(from: Collection<FROM>) = BoundPathToMany(froms.plus(from), path)
...
fun <FROM : Vertex, TO> SingleBoundPathToOptional<FROM, TO>.add(from: Collection<FROM>) = BoundPathToOptional(froms.plus(from), path)
...
fun <FROM : Vertex, TO> SingleBoundPathToSingle<FROM, TO>.add(from: Collection<FROM>) = BoundPathToSingle(froms.plus(from), path)
...
fun <FROM : Vertex, TO : Vertex> SingleBoundRelationshipToMany<FROM, TO>.add(from: Collection<FROM>) = BoundRelationshipToMany(froms.plus(from), path)
...
fun <FROM : Vertex, TO : Vertex> SingleBoundRelationshipToOptional<FROM, TO>.add(from: Collection<FROM>) = BoundRelationshipToOptional(froms.plus(from), path)
...
fun <FROM : Vertex, TO : Vertex> SingleBoundRelationshipToSingle<FROM, TO>.add(from: Collection<FROM>) = BoundRelationshipToSingle(froms.plus(from), path)
