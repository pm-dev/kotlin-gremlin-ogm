package org.apache.tinkerpop.gremlin.ogm.steps.relationship
...
import org.apache.tinkerpop.gremlin.ogm.steps.path.relationship.*
...
interface Relationship<FROM : Vertex, TO : Vertex> : Step<FROM, TO> {
    ...
    interface FromSingle<FROM : Vertex, TO : Vertex> : FromOne<FROM, TO> {
        ...
        infix fun <NEXT : Vertex> link(next: SingleToMany<TO, NEXT>): SingleToMany<FROM, NEXT> = SingleToManyRelationshipPath(first = this, last = next)
    }
